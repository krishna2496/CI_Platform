...
class PaymentFailureRepositoryTest extends TestCase
{
    /**
     * @var Faker
     */
    ...
    /**
     * @var App\Models\PaymentGateway\PaymentFailure
     */
    ...
    public function setUp(): void
    {
        ...
        $this->paymentFailure = $this->mock(PaymentFailure::class);
    }
    ...
    public function testCreate()
    {
        ...
        $this->paymentFailure
            ...
            ->once()
            ->with([
                'payment_gateway_payment_id' => $paymentFailure->payment_gateway_payment_id,
                'failure_data' => $paymentFailure->failure_data
            ])
            ->andReturn($paymentFailure);

        $paymentFailureRepository = new PaymentFailureRepository(
            $this->paymentFailure
        );
        $response = $paymentFailureRepository->create($paymentFailure);
