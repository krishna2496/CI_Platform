...
class AlterTableChangeEnumTypeValueForOrganizationInActivityLogTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('activity_log', function (Blueprint $table) {
            ...
            \DB::statement("ALTER TABLE `activity_log` CHANGE `object_id` `object_id` VARCHAR(36) NULL DEFAULT NULL");
        });
    }
    ...
    public function down()
    {
        Schema::table('activity_log', function (Blueprint $table) {
            ...
            \DB::statement("ALTER TABLE `activity_log` CHANGE `object_id` `object_id` bigint(20) NULL DEFAULT NULL");
        });
    }
}
